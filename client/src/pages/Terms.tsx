    ...
    <div className="min-h-screen bg-brand-dark text-white">
      ...
      <main className="container max-w-4xl py-12 px-4">
        <div className="prose prose-invert prose-slate max-w-none">
          ...
          <p className="text-slate-300 mb-4">
            <strong className="text-brand-gold">IMPORTANT:</strong> The information provided through this Service is for educational and informational purposes only and is not intended as medical advice. The content is not intended to be a substitute for professional medical advice, diagnosis, or treatment.
          </p>
          <p className="text-slate-300 mb-4">
