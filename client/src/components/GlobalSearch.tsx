...
const searchItems: SearchItem[] = [
  ...
  { id: "sales", title: "Sales Report", description: "View sales analytics", path: "/admin/sales-report", icon: <TrendingUp className="h-4 w-4" />, category: "navigation", keywords: ["revenue", "income", "money", "earnings"] },
  { id: "recommendations", title: "Recommendations", description: "Protocol recommendations", path: "/admin/recommendations", icon: <ListChecks className="h-4 w-4" />, category: "navigation", keywords: ["rules", "conditions", "guidelines", "suggestions"] },
  ...
  { id: "affiliate", title: "Affiliate Analytics", description: "Affiliate performance", path: "/admin/affiliate-analytics", icon: <BarChart3 className="h-4 w-4" />, category: "navigation", keywords: ["partners", "referrals", "commissions"] },
  ...
  { id: "coupons", title: "Coupons", description: "Manage discount codes", path: "/admin/coupons", icon: <Ticket className="h-4 w-4" />, category: "navigation", keywords: ["discounts", "promo", "codes", "vouchers"] },
  ...
  { id: "automation", title: "Automation Dashboard", description: "Client onboarding automation", path: "/admin/automation", icon: <Zap className="h-4 w-4" />, category: "navigation", keywords: ["automation", "onboarding", "workflow", "trigger", "pipeline"] },
  { id: "consultation-notes", title: "Consultation Notes", description: "Post-consultation notes for Shannon", path: "/admin/consultation-notes", icon: <StickyNote className="h-4 w-4" />, category: "navigation", keywords: ["notes", "consultation", "consult", "jason", "shannon", "strategy"] },
