  ...
  app.use(helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        imgSrc: ["'self'", "data:", "https:", "blob:", "https://files.manuscdn.com", "https://maps.gstatic.com", "https://maps.googleapis.com"],
        fontSrc: ["'self'", "https://fonts.gstatic.com", "data:"],
        connectSrc: ["'self'", "https://api.manus.im", "https://files.manuscdn.com", "https://maps.googleapis.com", "https://places.googleapis.com", "wss:", "ws:"],
